...
function xmldb_recordingszoom_upgrade($oldversion) {
    ...
    if ($oldversion < 201809110000) {
        ...
        $field = new xmldb_field('zoom_meeting_id_2', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null , null, null);
        // Add field course.
        ...
        // Define field course to be added to recordingszoom.
        $table = new xmldb_table('recordingszoom');
        $field = new xmldb_field('zoom_meeting_id_3', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null);
        // Add field course.
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }
        ...
        // Define field course to be added to recordingszoom.
        $table = new xmldb_table('recordingszoom');
        $field = new xmldb_field('zoom_meeting_id_4', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null);
        // Add field course.
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }
